...
int main(void)
{
	...
	char str[128];
	if (bAccuracy == false)
		sprintf(str, "SUM Output: Comparison of CPU and GPU Vector Addition is not within accuracy of 0.000001 at array index %d", breakValue);
	else
		sprintf(str, "SUM Output: Comparison of CPU and GPU Vector Addition is within accuracy of 0.000001");
	...
	printf("SUM Output: OpenCL Kernel Global Work Size = %zu and Local Work Size = %zu\n\n", globalWorkSize, localWorkSize);
