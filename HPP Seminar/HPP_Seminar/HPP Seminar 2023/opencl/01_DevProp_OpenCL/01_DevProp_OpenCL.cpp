...
void printOpenCLDeviceProperties(void)
{
	...
	else
	{
		...
		{
			printf("\n");
			printf("******============******SUM GPU DEVICE GENERAL INFORMATION ******============******\n");
			printf("========================================================================================================\n\n");
			printf("GPU Device Number                               : %d\n", i);
			clGetDeviceInfo(ocl_device_ids[i], CL_DEVICE_NAME, sizeof
			(ocl_dev_prop), &ocl_dev_prop, NULL);
			...
			printf("\n");
			printf("******============******SUM GPU DEVICE MEMORY INFORMATION ******============******\n");
			printf("========================================================================================================\n\n");
			cl_ulong mem_size;
			...
			printf("\n");
			printf("******============******SUM GPU DEVICE COMPUTE INFORMATION ******============******\n");
			printf("========================================================================================================\n\n");
