...
{	
	...
	glBegin(GL_LINE_STRIP); // Outer Rectangle 
	...
	glBegin(GL_LINE_STRIP); // Window - L	
	...
	glColor3f(0.118, 0.564, 1.0); // Deep Sky Blue
	glBegin(GL_LINE_STRIP); // Window - R	
	...
	glBegin(GL_LINES); // Door Frame - 2

	glVertex3f(1.5f, 0.0f, 0.0f);
	glVertex3f(1.5f, 0.27f, 0.0f);
