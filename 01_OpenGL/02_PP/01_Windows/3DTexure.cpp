...
int initialize(void)
{
	...
	//Now ghdc will end handing over  control to ghrc
	//Make Rendering as Context Current here
	...
	//Link the shader program object here
	...
	glDepthFunc(GL_LEQUAL); // Compulsary - Depth <= 
