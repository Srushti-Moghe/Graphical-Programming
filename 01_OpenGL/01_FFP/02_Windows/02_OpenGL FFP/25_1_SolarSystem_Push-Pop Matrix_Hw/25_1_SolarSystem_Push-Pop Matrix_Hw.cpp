...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	*/
	...
	gpFile = fopen("25_1_SolarSystem_Push-Pop Matrix_Hw.txt", "w");
	if (gpFile == NULL)
	{
...
void display(void)
{
	...
	// gluSphere(quadric, radius, latitude, longitude);
	// More Tissilation (more subdivision) ~ more refined / detailed object ~ less Performance
	...
	glRotatef(90.0f, 1.0f, 0.0f, 0.0f);
	gluSphere(quadric, 0.15f, 100, 100);
