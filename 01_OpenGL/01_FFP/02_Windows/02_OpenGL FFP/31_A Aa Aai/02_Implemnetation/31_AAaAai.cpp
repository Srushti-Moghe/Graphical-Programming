...
GLuint texture_01_Aai =0;
GLuint texture_02_Maka =0;
GLuint texture_03_Mama =0;
GLuint texture_04_Muka = 0;

GLuint picno1=0,picno2=0,picno3=0,picno4=0;
...
texture_01_Aai = createTexture2D("01_Aai.jpg");

texture_02_Maka = createTexture2D("02_Maka.jpg");

texture_03_Mama = createTexture2D("03_Mama.jpg");

texture_04_Muka = createTexture2D("04_Muka.jpg");
...
void display()
{
	...
	{
		glPushMatrix();
		drawcube(texture_01_Aai, texture_01_Aai, texture_01_Aai, texture_01_Aai, 0.0f,0.2f,incrZ,  1.0f,1.0f,1.0f);
		glPopMatrix();  
	}
	...
	{  
		glPushMatrix();
		drawcube(texture_02_Maka, texture_02_Maka, texture_02_Maka, texture_02_Maka, 0.0f,0.2f,incrZ,  1.0f,1.0f,1.0f);
		glPopMatrix();  	
 	}
	...
	{
		glPushMatrix();
		drawcube(texture_03_Mama, texture_03_Mama, texture_03_Mama, texture_03_Mama, 0.0f,0.2f,incrZ,  1.0f,1.0f,1.0f);
		glPopMatrix(); 
	} 	
	...
	{
		glPushMatrix();
			drawcube(texture_04_Muka, texture_04_Muka, texture_04_Muka, texture_04_Muka, 0.0f,0.2f,incrZ,  1.0f,1.0f,1.0f);
		glPopMatrix();
...
void uninitialize(void)
{
	...
	if (texture_04_Muka)
	{
		glDeleteTextures(1,&texture_04_Muka);
		texture_04_Muka = 0;
	}
	
	if (texture_03_Mama)
	{
		glDeleteTextures(1,&texture_03_Mama);
		texture_03_Mama = 0;
	}

	if (texture_02_Maka)
	{
		glDeleteTextures(1, &texture_02_Maka);
		texture_02_Maka = 0;
	}
	
	if (texture_01_Aai)
	{
		glDeleteTextures(1,&texture_01_Aai);
		texture_01_Aai = 0;
	}
