...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	*/
	...
	gpFile = fopen("13_ConcentricSquares.txt", "w");
	if (gpFile == NULL)
	{
...
void display(void)
{
	...
	for (i = 0; i <= 9; i++)
	{
		...
		glVertex3f(xCoord, yCoord, 0.0f); // 1
		glVertex3f(-xCoord, yCoord, 0.0f); // 2
		glVertex3f(-xCoord, -yCoord, 0.0f); // 3
		glVertex3f(xCoord, -yCoord, 0.0f); // 4
		glVertex3f(xCoord, yCoord, 0.0f); // closing at 1
