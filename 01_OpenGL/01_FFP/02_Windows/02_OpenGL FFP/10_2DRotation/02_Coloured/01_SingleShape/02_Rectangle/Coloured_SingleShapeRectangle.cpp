...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	gpFile = fopen("Coloured_SingleShapeRectangle.txt", "w");
	if (gpFile == NULL)
	{
...
void display(void)
{
	...
	// Counterclockwise 
	// Coordinate Order - RightTop, LeftTop, LeftBottom, RightBottom
	...
	glVertex3f(-1.0f, -1.0f, 0.0f);		// LB

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex3f(1.0f, -1.0f, 0.0f);		// RB
