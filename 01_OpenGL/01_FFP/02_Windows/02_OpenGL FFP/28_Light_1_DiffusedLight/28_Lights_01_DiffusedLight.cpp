...
BOOL gbLight = FALSE;
// GLfloat lightAmbient[] = {0.5f, 0.5, 0.5f, 1.0f};			// Grey Ambient Light
GLfloat lightAmbient[] = {0.905f, 0.749f, 0.721f, 1.0f};			// Grey Ambient Light
// GLfloat lightDiffuse[] = {1.0f, 1.0f, 1.0f, 1.0f};			// White Diffused Light
GLfloat lightDiffuse[] = {0.933f, 0.615f, 0.690f, 1.0f};			// White Diffused Light
// GLfloat lightPosition[] = {0.0f, 0.0f, 2.0f, 1.0f};			// GLfloat lightPosition[] = {x, y, z, w=0/1};
GLfloat lightPosition[] = {5.0f, 5.0f, 0.0f, 1.0f};			// GLfloat lightPosition[] = {x, y, z, w=0/1};
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	gpFile = fopen("28_Lights_01_DiffusedLight.txt", "w");
	if (gpFile == NULL)
	{
...
int initialize(void)
{
	...
	glLightfv(GL_LIGHT1, GL_AMBIENT, lightAmbient);		// Enabling light1 out of 8 lights
	glLightfv(GL_LIGHT1, GL_DIFFUSE, lightDiffuse);		
	glLightfv(GL_LIGHT1, GL_POSITION, lightPosition);		
	glEnable(GL_LIGHT1);	// Enabling all the above set properties
