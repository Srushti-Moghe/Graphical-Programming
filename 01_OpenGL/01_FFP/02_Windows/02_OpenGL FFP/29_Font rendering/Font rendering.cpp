...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	*/
	...
	gpFile = fopen("Font rendering.txt", "w");
	if (gpFile == NULL)
	{
...
GLuint BuildFont(char* name, int fontSize)
{
	HFONT font;
	HFONT oldFont;
	...
	wglUseFontBitmaps(ghdc, 32, 256, base);
...
void glPrint(GLuint base, const char* str, ...)
{
	...
	glListBase(base - 32);
	glCallLists(strlen(text), GL_UNSIGNED_BYTE, str);
	glPopAttrib();
