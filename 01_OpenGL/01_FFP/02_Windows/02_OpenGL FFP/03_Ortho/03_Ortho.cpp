...
void resize(int width, int height)
{
	...
	if (height <= 0)
	{
		...
		if (width <= height)
		{
			// Cuboidal Viewing Volume
			// glFrustum(left, right, top, bottom, near, far);		// angle of 45deg 
			// glOrtho(left, right, top, bottom, near, far);		// angle of 90deg
