...
HRESULT initialize(void)
{
	...
	d3dInputElementDesc[0].Format = DXGI_FORMAT_R32G32B32A32_FLOAT;
	...
	d3dInputElementDesc[1].Format = DXGI_FORMAT_R32G32B32A32_FLOAT;
...
void display(void)
{
	...
	// Angle(+ve) --> Right to Left Rotation
	// Angle(-ve) --> Left to Right Rotation
	worldMatrix = XMMatrixRotationY(-XMConvertToRadians(pAngle)*XMMatrixTranslation(0.0f, 0.0f, 3.0f));
