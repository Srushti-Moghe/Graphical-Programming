...
HRESULT initialize(void)
{
	...
	const float rectagle_position[] = {
										-1.0f, 1.0f, 0.0f,	// LT
										1.0f, 1.0f, 0.0f,	// RT
										-1.0f, -1.0f, 0.0f,	// LB
										
										// Triangle List Sequence -> LT, RT, LB and LB, RT, RB 
										-1.0f, -1.0f, 0.0f,	// LB
										1.0f, 1.0f, 0.0f,	// RT
										1.0f, -1.0f, 0.0f,	// RB
									  };
	...
	d3d11BufferDesc.ByteWidth = sizeof(rectagle_position);
	...
	memcpy(d3d11MappedSubresource.pData, rectagle_position, sizeof(rectagle_position));
