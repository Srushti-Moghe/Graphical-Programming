...
int main(void)
{
	...
	// Using Array Name as an Array : value of xth element of iArray :
	// iArray[x] and address of xth element of iArray : &iArray[x]

	printf("\n\n");
	printf("Using Array Name as an Array : value of xth element of iArray : iArray[x] and address of xth element of iArray : &iArray[x]\n\n");
	...
	// Assigning teh base address of integer array 'iArray[]' to integer Pointer
	// Name of an Array == its Base Address
	ptr_S_iArray = S_iArray; // Equivalent to >> ptr_S_iArray = &S_iArray[0]

	// Using Pointer Name as Pointer : value of xth element of iArray :
	// ptr_iArray[x] and address of xth element of iArray : ptr_iArray + x

	printf("\n\n");
	printf("Using Pointer Name as Pointer : value of xth element of iArray :  ptr_iArray[x] and address of xth element of iArray : ptr_iArray + x\n\n");
	printf("Integer Array Elements and the Addresses they occupy are as follows : \n\n");
