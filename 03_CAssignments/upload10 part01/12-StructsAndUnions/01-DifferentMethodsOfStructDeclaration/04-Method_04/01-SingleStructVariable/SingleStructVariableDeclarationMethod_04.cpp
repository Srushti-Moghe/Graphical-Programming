...
int main(void)
{
	...
	struct SUM_MyData SUM_Data; // Local Declaration of struct variable SUM_Data (that includes 4 different data types), with SUM_MyData as its datatype
	...
	SUM_Data.SUM_i = 450;
	SUM_Data.SUM_f = 43.66f;
	SUM_Data.SUM_d = 95.59750345;
	SUM_Data.SUM_c = 'R';
