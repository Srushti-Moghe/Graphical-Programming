...
struct SUM_MyData SUM_Data; // Global Declaration of variable SUM_Data (that includes 4 different data types), with SUM_MyData as its datatype
...
int main(void)
{
	...
	SUM_Data.SUM_i = 50;
	SUM_Data.SUM_f = 4.56f;
	SUM_Data.SUM_d = 7.8650345;
	SUM_Data.SUM_c = 'Z';
